...
async function run() {
  const res = await fetch(`${SUPABASE_URL}/rest/v1/student_notes?select=id,title,category,system_category,system,group_name&title=ilike.*Maternal*`, {
    headers: {
  ...
  console.log("Maternal Notes Data:");
  console.log(data);
}
run();
